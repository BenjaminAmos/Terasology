...
public final class CanvasUtility {
    ...
    public static void drawMesh(Canvas canvas, Mesh mesh, Texture texture, Rectanglei region, Quat4f rotation, Vector3f offset, float scale) {
    ...
    public static void drawMesh(Canvas canvas, Mesh mesh, Material material, Rectanglei region, Quat4f rotation, Vector3f offset, float scale) {
        // TODO: Find a way to abstractly implement drawMesh in NUI
    ...
    public static SubRegion subRegionFBO(Canvas canvas, ResourceUrn uri, Vector2i size) {
